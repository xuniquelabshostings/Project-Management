      ...
      <div className="p-8">
        <div className="text-center mb-6">
          ...
          <p className="text-xs text-muted mt-1.5">
            Sign in to access clients, projects, and internal workspace
          </p>
        </div>
        ...
        <div className="mt-6 pt-5 border-t border-border/50 text-center">
          <p className="text-[11px] text-muted leading-relaxed">
            Notice: Public registration is strictly disabled. Team access is managed
            by administrators via email invitation.
          </p>
        </div>
      </div>
    </Card>
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-background p-4 sm:p-6 md:p-12 relative">
      ...
      <div className="text-center text-xs text-muted/80 pb-2">
        <p>Xunique Labs Internal Operating System &bull; Enforced via Row Level Security</p>
      </div>
    </div>
  );
}
